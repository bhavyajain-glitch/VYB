...
const { getMe, updateProfile, checkUsername, searchUsers, getUserById, followUser, deleteAccount, reportUser, blockUser, unblockUser } = require('../controllers/userController');
